...
describe("MessageBox", () => {
    ...
    test("render", () => {
        ...
        const wrapper = render(<MessageBox getContainer={container}><p>Hello</p></MessageBox>, { container });
    ...
    test("initial focus", () => {
        ...
        const wrapper = render(
            <div>
                ...
                <MessageBox visible={false} getContainer={container} initialFocus=".btn"><button className="btn">对话框内按钮</button></MessageBox>
            </div>, { container }
        );
        ...
        wrapper.rerender(
            <div>
                <button>对话框外面的按钮</button>
                <MessageBox visible={true} getContainer={container} initialFocus=".btn"><button className="btn">对话框内按钮</button></MessageBox>
            </div>
        );
    ...
    test('not fixed', () => {
        ...
        const wrapper = render(
            <MessageBox visible={false} fixed={false} getContainer={container}>abc</MessageBox>, { container }
        );
    ...
    test('hide mask', () => {
        ...
        const wrapper = render(
            <MessageBox visible={false} showMask={false} getContainer={container}>abc</MessageBox>, { container }
        );
    ...
    test('close mask', () => {
        ...
        render(
            <MessageBox defaultVisible={true} getContainer={container}>abc</MessageBox>, { container }
        );
    ...
    test('close not mask', () => {
        ...
        render(
            <MessageBox defaultVisible={true} maskClose={false} getContainer={container}>abc</MessageBox>, { container }
        );
    ...
    test('event', () => {
        ...
        render(
            <MessageBox defaultVisible={true} onChange={onChange} onKeyDown={onKeyDown} onUnmount={onUnmount} onClose={onClose} getContainer={container}>abc</MessageBox>, { container }
        );
        const messagebox = container.querySelector('.xy-messagebox');
    ...
    test('get close function', () => {
        ...
        let close: Function;
        render(
            <MessageBox defaultVisible={true} getCloseFunc={c => close = c} getContainer={container}>abc</MessageBox>, { container }
        );
        const messagebox = container.querySelector('.xy-messagebox');
        act(() => close());
        fireEvent.transitionEnd(container.querySelector('.xy-messagebox-content'));
